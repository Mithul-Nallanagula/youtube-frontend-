            ...
            <div className='video-show-page'>
                <div className="share-box" style={{ display: sharePage ? 'flex' : 'none' }}>
                    <div className="box">
                        <div className="top">
                            <p>Copy the Link</p>
                            <i className="ri-close-large-fill cursor-pointer" onClick={() => setSharePage(false)}></i>
                        </div>
                ...
                <div className="left">
                    ...
                    <div className="btns pl-1">
                        ...
                        <div className="like">
                            {curruser && curruser.likedVideos.includes(video._id) ? <i onClick={handelLike} className="ri-thumb-up-fill llike text-black"><p>{video.likes}</p></i> :
                ...
                <div className="s-right">
                    {videos.length > 0 ? (
                        videos.map((video, index) => {
                            return <VideoCard2 video={video} key={video._id}></VideoCard2>
                        })
                    ) : (
